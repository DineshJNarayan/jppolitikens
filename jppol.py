...
## print(len(df['views_date']))

plt.rcParams["figure.figsize"] = [7.50, 3.50]
plt.rcParams["figure.autolayout"] = True
# plt.plot(df.views_date, df.users_total_users, label="Total users")
# plt.plot(df.views_date, df.views_total_views, label="Total views")
# plt.xticks(df.views_date, rotation=90)
# plt.yticks(df.users_total_users)
# plt.show()
